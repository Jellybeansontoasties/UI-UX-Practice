...
const hoverStates = {
  ...
  logo:{
    work: { top: "0%", left: "0%", height: "70%", width: "30%" },
    connect: { top: "0%", right: "0%", height: "30%", width: "70%" },
    about: { bottom: "0%", left: "0%", height: "30%", width: "70%" },
    community: { bottom: "0%", right: "0%", height: "70%", width: "30%" },
    logo: {top: "50%", left: "50%", height: "40%", width: "40%" },
  }
};
